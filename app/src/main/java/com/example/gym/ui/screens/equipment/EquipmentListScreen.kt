...
fun EquipmentListScreen(
    ...
    val exercises = exerciseDataManager.getEquipmentExercises(equipmentType)

    Scaffold(
        modifier = modifier.fillMaxSize(),
        topBar = {
            AppTopBar(
                title = equipmentType.displayName,
                showBackButton = true,
...
@Composable
private fun EquipmentListScreenDarkPreview() {
...
@Preview(showBackground = true)
@Composable
private fun EquipmentListScreenLightPreview() {
